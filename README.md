...
>
> Keep claude-rtl for the one thing only an app patch can fix: the direction of the text **you type** and of everything else in the app's UI. The two are complementary; readable covers the day-to-day pain (Claude's replies) the safe way.
